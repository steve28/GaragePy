...
def mqtt_callback(topic, payload):
    ...
    print("prev_left_contact:", prev_left_contact)
    print("prev_right_contact:", prev_right_contact)
...
def main():
    # globals
    global prev_left_contact, prev_right_contact, prev_temp, prev_humid, last_check

    # connect to the WLAN
    do_connect()

    # connect to the MQTT server
    c = MQTTClient("my_client","192.168.1.8")
